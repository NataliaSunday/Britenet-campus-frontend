    ...
    .then( cartProduct => {
        ...
        if(cartProduct.length  != 0){
          ...
          `
            ...
            `
            <tr class="table__row">
                <td class="table__col" colspan="5">Your cart is empty</td>
